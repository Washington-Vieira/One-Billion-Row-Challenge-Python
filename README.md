...
3. Execute o comando `python src/create_measurements.py` para gerar o arquivo de teste (IMPORTANTE!! foi tirado um '0' no `create_measurements.py` linha 126, para não demorar gerar. adicione o 0 novamente)
